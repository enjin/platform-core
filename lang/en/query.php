...
return [
    ...
    'get_token_group.args.collectionId' => 'The collection ID that owns the token group.',
    'get_token_group.args.tokenGroupId' => 'The on-chain token group ID.',
    'get_token_group.description' => 'Get a token group by its collection and chain ID.',
    'get_token_groups.args.collectionId' => 'The collection to return token groups from, or omit to return all.',
    'get_token_groups.description' => 'Get a paginated list of token groups, optionally filtered by collection.',
    ...
    'get_listings.description' => 'Get market listings.',
    'get_listing.description' => 'Get market listing.',
    'get_listings.args.account' => 'The wallet account.',
    'get_bids.description' => 'Get the market listing bids.',
    'get_bid.description' => 'Get the market listing bid.',
    'get_sales.description' => 'Get the market listing sales.',
    'get_sale.description' => 'Get the market listing sale.',
];
