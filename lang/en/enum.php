...
return [
    ...
    'freeze_state_type.description' => 'The freeze state type.',
    'freezable_type.description' => 'The freezable objects supported on-chain.',
    ...
    'token_mint_cap_type.description' => 'The mint cap. The token will be classified as fungible if the cap is set to either infinite, or supply with a value higher than one.',
