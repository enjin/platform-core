...
MD,
    ...
    'token_group.description' => 'A group of tokens within a collection.',
    'token_group.field.id' => 'The token group chain ID.',
    'token_group.field.collection' => 'The collection this token group belongs to.',
    'token_group.field.attributes' => 'The attributes set on this token group.',
    'token_group.field.tokens' => 'The tokens in this token group.',
    'token_group.field.metadata' => 'The metadata resolved from the token group\'s URI attribute.',
    'token_group_token.description' => 'A token membership in a token group.',
    'token_group_token.field.token' => 'The token in this group.',
    'token_group_token.field.tokenGroup' => 'The token group this token belongs to.',
    'token_group_token.field.position' => 'The position of the token within the group.',
    'token.field.tokenGroups' => 'The token groups this token belongs to.',
    'collection_type.field.tokenGroups' => 'The token groups for this collection.',
    'attribute.field.tokenGroup' => 'The token group this attribute belongs to.',
];
