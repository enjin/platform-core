...
return [
    ...
    'args.signingAccount' => 'The wallet that signs and broadcasts the transaction. Defaults to the wallet daemon.',
    ...
    'batch_set_attribute.args.key' => "The attribute key. (e.g. 'name' or 'external_url').",
    ...
    'batch_transfer.args.signingAccount' => 'The wallet that signs and broadcasts the transaction. Defaults to the wallet daemon.',
...
MD,
    ...
    'infuse.description' => 'Infuse a token with ENJ. This will increase the token\'s value.',
    'infuse.args.tokenId' => 'The token that will be infused.',
    'infuse.args.amount' => 'The amount of ENJ to infuse.',
