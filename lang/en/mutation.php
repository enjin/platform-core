...
return [
    ...
    'batch_mint.args.continueOnFailure' => 'If set to true this option will skip data that would cause the whole batch to fail. Defaults to false.',
    ...
    'batch_set_attribute.args.collectionId' => 'The collection ID that you be adding attributes to.',
    ...
    'batch_transfer.description' => 'Use this method to transfer multiple tokens in one transaction. You can include up to 250 different transfers per batch. Set the continueOnFailure to true to allow all valid transfers to complete while skipping transfers which would fali so they can be fixed and attempted again in another transaction.',
    'batch_transfer.args.continueOnFailure' => 'Whether to make the possible extrinsics if one of them fails. Defaults to false.',
    'burn.args.collectionId' => 'The collection ID to create this token in.',
