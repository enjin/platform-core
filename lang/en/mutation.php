...
MD,
    ...
    'create_token_group.args.collectionId' => 'The ID of the collection this token group will belong to.',
    'create_token_group.description' => 'Creates a new token group belonging to the specified collection.',
    'destroy_token_group.args.tokenGroupId' => 'The on-chain ID of the token group to destroy.',
    'destroy_token_group.description' => 'Destroys a token group. The group must have no remaining tokens or attributes.',
    'add_token_to_group.args.collectionId' => 'The ID of the collection the token and group belong to.',
    'add_token_to_group.args.tokenGroupId' => 'The on-chain ID of the token group to add the token to.',
    'add_token_to_group.description' => 'Adds a token to an existing token group within the same collection.',
    'remove_token_from_group.args.collectionId' => 'The ID of the collection the token and group belong to.',
    'remove_token_from_group.args.tokenGroupId' => 'The on-chain ID of the token group to remove the token from.',
    'remove_token_from_group.description' => 'Removes a token from a token group.',
    'set_token_groups.args.collectionId' => 'The ID of the collection the token belongs to.',
    'set_token_groups.args.tokenGroups' => 'The complete list of token group IDs the token should belong to. Replaces any existing memberships.',
    'set_token_groups.description' => 'Sets the complete list of token groups a token belongs to, replacing any existing memberships.',
    'set_token_group_attribute.args.tokenGroupId' => 'The on-chain ID of the token group.',
    'set_token_group_attribute.args.key' => 'The attribute key to set.',
    'set_token_group_attribute.args.value' => 'The attribute value to set.',
    'set_token_group_attribute.description' => 'Sets an attribute on a token group.',
    'remove_token_group_attribute.args.tokenGroupId' => 'The on-chain ID of the token group.',
    'remove_token_group_attribute.args.key' => 'The attribute key to remove.',
    'remove_token_group_attribute.description' => 'Removes an attribute from a token group.',
];
