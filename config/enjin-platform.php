        ...
        'supported' => [
            'substrate' => [
                ...
                NetworkType::CANARY_MATRIX->value => $canary = [
                    ...
                    'spec-version' => env('SUBSTRATE_CANARY_SPEC_VERSION', 1011),
                    'transaction-version' => env('SUBSTRATE_CANARY_TRANSACTION_VERSION', 9),
                ],
                'canary' => $canary,
                ...
                NetworkType::CANARY_RELAY->value => [
                    ...
                    'spec-version' => env('SUBSTRATE_CANARY_RELAY_SPEC_VERSION', 1030),
                    'transaction-version' => env('SUBSTRATE_CANARY_RELAY_TRANSACTION_VERSION', 12),
                ],
