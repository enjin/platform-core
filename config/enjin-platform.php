        ...
        'supported' => [
            'substrate' => [
                'enjin' => [
                    ...
                    'spec-version' => env('SUBSTRATE_ENJIN_SPEC_VERSION', 605),
                    'transaction-version' => env('SUBSTRATE_ENJIN_TRANSACTION_VERSION', 3),
                ],
                'canary' => [
                    'chain-id' => 0,
                    'network-id' => 2010,
                    ...
                    'spec-version' => env('SUBSTRATE_CANARY_SPEC_VERSION', 605),
                    'transaction-version' => env('SUBSTRATE_CANARY_TRANSACTION_VERSION', 3),
                ],
                'local' => [
                    'chain-id' => 0,
                    'network-id' => 104,
                    ...
                    'spec-version' => env('SUBSTRATE_LOCAL_SPEC_VERSION', 605),
                    'transaction-version' => env('SUBSTRATE_LOCAL_TRANSACTION_VERSION', 3),
                ],
            ],
        ],
