...
class GetCollectionsTest extends TestCaseGraphQL
{
    ...
    public function test_it_can_get_total_count_correctly(): void
    {
        ...
        Token::factory($tokenCount1 = random_int(1, 15))->create(['collection_id' => $collection1->id]);
        CollectionAccount::factory($accountCount1 = random_int(1, 15))->create(['collection_id' => $collection1->id]);
        $collection2 = $collections->shift();
        Token::factory($tokenCount2 = random_int(1, 15))->create(['collection_id' => $collection2->id]);
        CollectionAccount::factory($accountCount2 = random_int(1, 15))->create(['collection_id' => $collection2->id]);
