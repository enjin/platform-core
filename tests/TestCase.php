...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        Cache::rememberForever(PlatformCache::SPEC_VERSION->key(currentMatrix()->value), fn () => 1030);
        Cache::rememberForever(PlatformCache::TRANSACTION_VERSION->key(currentMatrix()->value), fn () => 12);
