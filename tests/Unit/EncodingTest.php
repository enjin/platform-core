...
class EncodingTest extends TestCase
{
    ...
    public function test_it_can_encode_batch_transfer_simple_transfer()
    {
        ...
        $this->assertEquals(
            "0x{$callIndex}411f0452e3c0eb993523286d19954c7e3ada6f791fa3f32764e44b9c1df0c2723bc15e00fd0304",
            $data
        );
    }
    ...
    public function test_it_can_encode_simple_transfer()
    {
        ...
        $this->assertEquals(
            "0x{$callIndex}0052e3c0eb993523286d19954c7e3ada6f791fa3f32764e44b9c1df0c2723bc15e411f00fd0304",
            $data
        );
    }
    ...
    public function test_it_can_encode_create_collection_with_args()
    {
        ...
        $this->assertEquals(
            "0x{$callIndex}01ff0000000000000001adde0000000000000000000000000000010104301cb3057d43941d5f631613aa1661be0354d39e34f23d4ef527396b10d2bb7a0208af2f04000008106e616d653c44656d6f20436f6c6c656374696f6e2c6465736372697074696f6e484d792064656d6f20636f6c6c656374696f6e",
            $data
        );
    }
    ...
    public function test_it_can_encode_batch_mint_token()
    {
        ...
        $callIndex = $this->codec->encoder()->getCallIndex('MultiTokens.batch_mint', true);
        $this->assertEquals(
            "0x{$callIndex}411f04d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d010404",
            $data
        );
    }
    ...
    public function test_it_can_encode_utility_batch_all()
    {
        ...
        $callIndex = $this->codec->encoder()->getCallIndex('Utility.batch_all', true);
        $this->assertEquals(
            "0x{$callIndex}0828040052e3c0eb993523286d19954c7e3ada6f791fa3f32764e44b9c1df0c2723bc15e0400fd03b67a03000000000000000000000000000028040052e3c0eb993523286d19954c7e3ada6f791fa3f32764e44b9c1df0c2723bc15e0400fd03b67a030000000000000000000000000000",
            $data
        );
    }
