...
class Encoder
{
    ...
    protected static array $callIndexKeys = [
        ...
        'SetAttributeV1022' => 'MultiTokens.set_attribute',
        ...
        'CreateTokenGroup' => 'MultiTokens.create_token_group',
        'DestroyTokenGroup' => 'MultiTokens.destroy_token_group',
        'AddTokenToGroup' => 'MultiTokens.add_token_to_group',
        'RemoveTokenFromGroup' => 'MultiTokens.remove_token_from_group',
        'SetTokenGroups' => 'MultiTokens.set_token_groups',
        'SetTokenGroupAttribute' => 'MultiTokens.set_token_group_attribute',
        'RemoveTokenGroupAttribute' => 'MultiTokens.remove_token_group_attribute',
        ...
        'CreateListingV1022' => 'Marketplace.create_listing',
