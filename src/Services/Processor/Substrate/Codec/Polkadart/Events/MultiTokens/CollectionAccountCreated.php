...
class CollectionAccountCreated implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): self
    {
        ...
        $self->collectionId = Arr::get($data, 'event.MultiTokens.CollectionAccountCreated.collection_id');
        $self->account = Arr::get($data, 'event.MultiTokens.CollectionAccountCreated.account_id');
