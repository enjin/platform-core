...
class TokenDestroyed implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): self
    {
        ...
        $self->collectionId = Arr::get($data, 'event.MultiTokens.TokenDestroyed.collection_id');
        $self->tokenId = Arr::get($data, 'event.MultiTokens.TokenDestroyed.token_id');
        $self->caller = Arr::get($data, 'event.MultiTokens.TokenDestroyed.caller');
