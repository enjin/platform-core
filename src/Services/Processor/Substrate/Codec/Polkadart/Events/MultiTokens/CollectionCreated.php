...
class CollectionCreated implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): self
    {
        ...
        $self->collectionId = Arr::get($data, 'event.MultiTokens.CollectionCreated.collection_id');
        $self->owner = Arr::get($data, 'event.MultiTokens.CollectionCreated.owner');
