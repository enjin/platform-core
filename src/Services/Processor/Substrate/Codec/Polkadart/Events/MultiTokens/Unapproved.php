...
class Unapproved implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): self
    {
        ...
        $self->collectionId = Arr::get($data, 'event.MultiTokens.Unapproved.collection_id');
        $self->tokenId = Arr::get($data, 'event.MultiTokens.Unapproved.token_id.Some');
        $self->owner = Arr::get($data, 'event.MultiTokens.Unapproved.owner');
        $self->operator = Arr::get($data, 'event.MultiTokens.Unapproved.operator');
