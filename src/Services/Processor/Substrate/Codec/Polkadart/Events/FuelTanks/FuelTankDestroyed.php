...
class FuelTankDestroyed implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): self
    {
        ...
        $self->tankId = is_string($key = Arr::get($data, 'event.FuelTanks.FuelTankDestroyed.tank_id')) ? $key : HexConverter::bytesToHex($key);
