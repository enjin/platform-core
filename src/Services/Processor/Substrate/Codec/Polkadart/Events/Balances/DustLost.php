...
class DustLost implements PolkadartEvent
{
    ...
    public static function fromChain(array $data): PolkadartEvent
    {
        ...
        $self->account = Arr::get($data, 'event.Balances.DustLost.account');
        $self->amount = Arr::get($data, 'event.Balances.DustLost.amount');
