...
use Enjin\Platform\Rules\AccountWaitingCollectionTransfer;
...
class AcceptCollectionTransferMutation extends Mutation implements PlatformBlockchainTransaction, PlatformGraphQlMutation
{
    ...
    {
        return [
            'name' => 'AcceptCollectionTransfer',
            'description' => __('enjin-platform::mutation.accept_collection_transfer.description'),
        ];
    }
    ...
    public function args(): array
    {
        return [
            'collectionId' => [
                ...
                'description' => __('enjin-platform::mutation.accept_collection_transfer.args.collectionId'),
            ],
