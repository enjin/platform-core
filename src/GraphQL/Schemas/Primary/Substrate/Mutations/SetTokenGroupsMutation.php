...
class SetTokenGroupsMutation extends Mutation implements PlatformBlockchainTransaction, PlatformGraphQlMutation
{
    ...
    public function attributes(): array
    {
        return [
            'name' => 'SetTokenGroups',
            'description' => __('enjin-platform::mutation.set_token_groups.description'),
        ];
    }
    ...
    public function args(): array
    {
        return [
            'collectionId' => [
                ...
                'description' => __('enjin-platform::mutation.set_token_groups.args.collectionId'),
            ],
            ...$this->getTokenFields(__('enjin-platform::args.common.tokenId')),
            'tokenGroups' => [
                'type' => GraphQL::type('[BigInt!]!'),
                'description' => __('enjin-platform::mutation.set_token_groups.args.tokenGroups'),
            ],
    ...
    protected function rulesWithValidation(array $args): array
    {
        return [
            ...
            'tokenGroups' => ['bail', 'array', 'min:0', 'max:20'],
            'tokenGroups.*' => ['bail', new MinBigInt(0), new MaxBigInt(Hex::MAX_UINT128)],
