...
class TokenGroupRemoved extends PlatformBroadcastEvent
{
    use HasCustomQueue;
     ...
     */
    public function __construct(TokenGroupRemovedPolkadart $event, ?Model $transaction = null, ?array $extra = null)
    {
        parent::__construct();
