...
class TokenGroupsUpdated extends PlatformBroadcastEvent
{
    use HasCustomQueue;
     ...
     */
    public function __construct(TokenGroupsUpdatedPolkadart $event, ?Model $transaction = null, ?array $extra = null)
    {
        parent::__construct();
