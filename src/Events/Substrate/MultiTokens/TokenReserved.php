...
use Enjin\Platform\Services\Processor\Substrate\Codec\Polkadart\Events\MultiTokens\Reserved as TokenReservedPolkadart;

class TokenReserved extends PlatformBroadcastEvent
{
    /**
