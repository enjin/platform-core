...
class TokenAccountCreated extends PlatformBroadcastEvent
{
    /**
     * Create a new event instance.
     */
    public function __construct(TokenAccountCreatedPolkadart $event, ?Model $transaction = null, ?array $extra = null)
    {
        parent::__construct();
